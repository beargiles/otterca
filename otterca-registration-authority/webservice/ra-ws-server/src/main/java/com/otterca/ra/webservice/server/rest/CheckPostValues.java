...
// import com.otterca.ca.util.StudentUtil;
...
public class CheckPostValues {
     ...
     * @throws Throwable
     */
    @Around("target(com.otterca.ca.webservice.server.rest.AbstractResource) && args(uuid,rto,..)")
     ...
     * @throws Throwable
     */
    @Around("target(com.otterca.ca.webservice.server.rest.AbstractResource) && args(uuid,version) && execution(* *.delete*(..))")
